...
RSpec.feature "タスク管理機能", type: :feature do
  ...
  background do
    ...
    FactoryBot.create(:second_task, task_name: 'test2', content: 'test2', created_at: Time.current + 2.days, deadline: '2019-11-15', status: '未着手', priority: '低')
    FactoryBot.create(:second_task, task_name: 'test3', content: 'test3', created_at: Time.current + 3.days, deadline: '2019-11-16', status: '未着手', priority: '中')
    FactoryBot.create(:second_task, task_name: 'test4', content: 'test4', created_at: Time.current + 4.days, deadline: '2019-11-17', status: '未着手', priority: '中')
  end
